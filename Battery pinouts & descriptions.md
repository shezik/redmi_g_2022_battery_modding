...
└──┴──┴──┴──┴──┴──┴──┴──┴──┴──┴──┘
 ...
 8. B/I          Battery Inserted (Low-active)
 9. GND          Ground
10. GND          Ground
11. GND          Ground
```
...
```
 ...
 4. BAT_PRS#   O  10K Ohm to ground, used to notify motherboard of battery presence. (Haven't tested)
 5. P+        IO  0.002 V w/o B/I; battery voltage w/ B/I
 6. P+        IO  Connected to 5
 7. P+        IO  Connected to 5
 8. B/I        I  When pulled to ground by 10K Ohm resistor on motherboard, P+ output is activated.
 9. GND       IO  Ground
